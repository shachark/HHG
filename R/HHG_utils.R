...
.MV_KS_HHG_EXTENDED  = as.integer(30)  
.MV_IND_HHG_NO_TIES  = as.integer(31)	
.MV_IND_HHG          = as.integer(32)			
.MV_IND_HHG_EXTENDED = as.integer(33)
...
.organize.results = function(res, n, nr.perm, tables.wanted, perm.stats.wanted, grid.len = 0, extra.stats.wanted = F, is.extended.test = F) {
