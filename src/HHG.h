...
#define IS_UV_DF_KS_TEST(tt) ((tt) == UV_KS_XDP2 || (tt) == UV_KS_XDP3 || (tt) == UV_KS_XDP)
...
#define IS_KS_TEST(tt) ( \
        ...
        (tt) == UV_KS_DS  || (tt) == UV_KS_MDS || (tt) == MV_TS_EXISTING)
...
struct TestIO {
	...
	SEXP R_output;
	double *obs_stats, *obs_tbls, *pvals, *perm_stats;
